...
//xx        return getString(Keys.USERNAME, R.string.valEmpty, R.string.valUsernamePublic, R.string.valEmpty, true, false);
        return getString(Keys.USERNAME, R.string.valUsernamePrivate, R.string.valUsernamePublic, R.string.valEmpty, true, false);
    }
    ...
    public static String getSubTopic() {
        ...
        username = getUsername();
        formatString = getStringRessource(R.string.valSubTopic);
        if(isModeMqttPrivate()) {
    ...
    //xx
        return getString(Keys.HOST, R.string.valHostPrivate, R.string.valHostPublic, R.string.valEmpty, true, false);
    }
    @Export(key =Keys.PASSWORD, exportModeMqttPrivate =true)
    public static String getPassword() {
    //xx
        return getString(Keys.PASSWORD, R.string.valPasswordPrivate, R.string.valEmpty, R.string.valEmpty, true, false);
    }
